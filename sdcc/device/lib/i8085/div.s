...
.dodiv:
        call    .divu16
        jp      C,.exit         ; Exit if divide by zero
...
.dvloop:
	...
	;; FIXME: convert these to go via a
	ld	a,l             ; Carry (next bit of quotient) to bit 0
	rla
	ld	l,a

        ld      a,h             ; Shift remaining bytes
	rla
	ld	h,a
	ld	a,c
	rla
	ld	c,a
	ld	a,b
	rla			; Clears carry since BC was 0
	ld	b,a
