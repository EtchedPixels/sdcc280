	...
	adc	a,l			;8D
	adc	a,#n			;CE 20
	adc	a, n			;CE 20  error; 'n' is a direct address, not an immediate
	;***********************************************************
data8:	.db	8
data16:	.dw	1000
	;***********************************************************
	...
	adc	a,(data)		;DD 8F rr ss
	adc	a,(nn+6)		;DD 8F 8A 05
	adc	a, n			;CE 20
	adc	a,data			;DD 8F rr ss	direct address
	adc	a,#data			;CE rr		immediate
	adc	a,(ix+nn)		;FD 89 84 05   X addressing mode
	adc	a,(iy+nn)		;FD 8A 84 05   X addressing mode
	adc	a,(hl+offset)		;FD 8B 55 00   X addressing mode
	...
	adc	a,(hl+iy)		;DD 8A
	adc	a,(ix+iy)		;DD 8B
	adc	a,(.+32)		;absolute addressing, relocated
	adc	a,[.+32]		;PC relative addressing
	adc	a,(pc+n)		;PC relative
	adc	a,[data]		;PC relative (linker help needed)
	adc	a,[data8]		;PC relative (absolute offset)
	adc	a,(pc + data8)		;ditto
	adc	a,data8(pc)		;ditto
	;***********************************************************
	...
	add	a,l			;85
	add	a,#n			;C6 20
;;;	add	a, n			;C6 20		direct address, not immediate
	;***********************************************************
