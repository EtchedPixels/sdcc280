...
data16:	.dw	1000
	...
	adc	a,(hl+iy)		;DD 8A
	adc	a,(ix+iy)		;DD 8B
	adc	a,(.+32)		;DD 8F 93 00
	adc	a,[.+32]		;FD 88 1C 00
	adc	a,(pc+n)		;FD 88 1E 00
	adc	a,[data]		;FD 88 8F FF
	adc	a,[data8]		;FD 88 97 FF
	adc	a,(pc + data8)		;FD 88 93 FF
	adc	a,data8(pc)		;FD 88 8F FF
	;***********************************************************
...
.if SHOW_ERRORS
	...
	ld	a,nn+4(iy)	;
	ld	a,(ix+nn+4)
	ld	a,(iy+offset+5)		;FD 7E 5A
	ld	bc,(gg+0x1234)		;ED 4Br34s12
	ld	d,# >(gg+0x1234)	;16s12
	ld	e,# <(gg+0x1234)	;1Er34
	out	( c ) , a	; ED 79
	out	c,a		;ED 79
	RES	14,(HL)
	RES	data,a
